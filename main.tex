...
\entidade{Centro Acadêmico da Matemática, Estatística e Computação Científica}
\data{Abril de 2025}
...
\artigo As assembleias destinadas à alteração do estatuto ou à dissolução do CAMECC somente poderão ser convocadas após a realização de 2 (duas) reuniões abertas, de caráter não-deliberativo, previamente convocadas e dedicadas exclusivamente a essa pauta.
...
\assinatura{Felipe Jardim Pinhati}{Presidente do CAMECC}

\assinatura{Adriana de Alcântara Cunha Passos}{OAB/SP 144.914}
